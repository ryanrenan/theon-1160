...
function onUse(cid,item,fromPosition,itemEx,toPosition)
                                  ...
                                  return doPlayerSendTextMessage(cid, MESSAGE_STATUS_CONSOLE_ORANGE, "Você não tem ice pet para vender (10000 gold coins = 10k = 10 crystal coins).")
                                  end
