function onUse(cid, item, fromPosition, itemEx, toPosition)
        ...
        local vocs = {6566,2158,2158,2154,2154,2158,2158,2154,2156}
        ...
        for x,i in pairs(getPlayersOnline()) do
                doPlayerSendTextMessage(i,19, "O jogador (" .. getPlayerName(cid).. ") completou o (Castle Devil): e ganhou 1000000 de experiências, 1 "..getItemNameById(vocs[getPlayerVocation(cid)]).." e "..gala..""..string.sub(add,1,10).." crystal coins!")
        end
