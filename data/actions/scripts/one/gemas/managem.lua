function onUse(cid, item, fromPosition, itemEx, toPosition)
        ...
        doSendAnimatedText(getCreaturePosition(cid), "+200 MP!", TEXTCOLOR_BLUE)
        doPlayerSendTextMessage(cid,19,"Foi adicionado +200 MP em seu personagem permanentemente!")
