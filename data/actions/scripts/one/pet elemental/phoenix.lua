local egg = {
["Branco"] = {id = 2695, mon = "Phoenix Pet"}
}
...
if getPlayerLevel(cid) <= 159 then
doPlayerSendTextMessage(cid, MESSAGE_STATUS_CONSOLE_ORANGE, "É necessário nível 160+ para invocar esse tipo de pet elemental.")
return true
end
