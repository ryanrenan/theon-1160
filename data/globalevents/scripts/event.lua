...
doBroadCastle(({"O castle será aberto em 30 minutos.", 120000) "O castle está aberto, seus portões serão fechados em 2 minutos.", "O castle está fechado, próximo castle em 1 hora."}, 120000)
return true
end