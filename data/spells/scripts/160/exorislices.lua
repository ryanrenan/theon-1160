...
function onGetFormulaValues(cid, level, skill, attack, factor)
	local skillTotal, levelTotal = skill + attack * 15, level / 5 * 15
	return -(skillTotal / 15 + levelTotal), -(skillTotal + levelTotal)
end
...
function onCastSpell(cid, var)
        doPlayerSendTextMessage(cid,27,"EFEITO MÁGICO: Tornado de estrelas foi ativado, afetando o inimigo múltiplas vezes (3x). O cálculo do dano é baseado em seu nível de skills e ataque da arma.")
