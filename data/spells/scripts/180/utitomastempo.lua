...
setConditionParam(condition, CONDITION_PARAM_SKILL_MELEEPERCENT, 138)
...
doPlayerSendTextMessage(cid,27,"EFEITO MÁGICO: Seu nível de skill foi aumentado em 150% durante 10 segundos.")
