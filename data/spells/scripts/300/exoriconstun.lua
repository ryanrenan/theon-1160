...
setCombatFormula(combat1, COMBAT_FORMULA_SKILL, 19, 11, 19, 11)
...
setCombatFormula(combat2, COMBAT_FORMULA_SKILL, 19, 11, 19, 11)
...
setCombatFormula(combat3, COMBAT_FORMULA_SKILL, 19, 11, 11, 20)
...
doPlayerSendTextMessage(cid,27,"EFEITO MÁGICO: Estrelas divinas foi ativada, afetando seu inimigo multiplas vezes (3x). O cálculo do dano é baseado sua distância e ataque da arma.")
