...
if rand == 2 then
selfSay('Oi! Venda suas escamas do devil castle aqui!') -- msg que vai sair do npc
end
if rand == 1 then
...
local trophy = {
    ["orshabaal"] = {2, 5909},    --{Quantidade de items aleatórios, ID do item}, 
    ["verminor"] = {5, 5910},
    ["apocalypse"] = {5, 5912}, 
    ["infernatil"] = {10, 5911},
    ["bazir"] = {15, 5913},
    ["castle master"] = {20, 5914}, 
}
