...
if(NpcHandler == nil) then
	...
	NpcHandler = {
		...
		messages = {
			...
			[MESSAGE_GREET] 	= 'Ola, |PLAYERNAME|! .',
			[MESSAGE_FAREWELL] 	= 'Thau, |PLAYERNAME|!',
			[MESSAGE_BUY] 		= 'Voce quer comprar |ITEMCOUNT| |ITEMNAME| por |TOTALCOST| gps?',
			[MESSAGE_ONBUY] 	= 'Foi um prazer fazer negocio com voce.',
			[MESSAGE_BOUGHT] 	= 'Comprado |ITEMCOUNT|x |ITEMNAME| por |TOTALCOST| gps.',
			...
			[MESSAGE_SOLD]	 	= 'Vendido |ITEMCOUNT|x |ITEMNAME| por |TOTALCOST| gps.',
